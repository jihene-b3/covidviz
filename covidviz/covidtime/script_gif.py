...
df_clean2.plot_animated("image/output/covid-19-h-bar-cases_departement.gif", period_fmt="%Y-%m-%d", title="Covid-19 : French departments'number of deaths",n_visible=15)
...
df_clean_r.plot_animated("image/output/covid-19-deaths-regions.gif", 
...
df_clean_r.plot_animated("image/output/covid-19-cases-region.gif", 
