...
rld.confinement_1 = rld.confinement_1.loc[
    rld.confinement_1['source_nom'] == "Santé publique France Data", :]
...
def confinement_1_dep_nom(department):
    x = pd.DataFrame(rld.confinement_1.loc[
        rld.confinement_1['maille_nom'] == f"{department}",
...
def confinement_1_dep_code(num_dep):
    x = pd.DataFrame(rld.confinement_1.loc[
        rld.confinement_1['maille_code'] == f"DEP-{num_dep}",
        'reanimation']).resample("1D").sum()
...
for nom_dep in DEP['nom'].tolist():
    reanimations_confinement_1_nom = pd.concat([
        reanimations_confinement_1_nom,
        confinement_1_dep_nom(f'{nom_dep}')],
        axis=1)
...
def rea_conf1_fr(reanimations_confinement_1_nom):
    fig = px.line(
        reanimations_confinement_1_nom,
        x="date", y=reanimations_confinement_1_nom.columns,
        hover_data={"date": "|%B %d, %Y"},
        title='ICU beds occupied in France by departments',
...
reanimations_confinement_1_Bretagne = pd.concat([
    ...
    reanimations_confinement_1_nom["Ille-et-Vilaine"]],
    axis=1)
...
reanimations_confinement_1_Normandie = pd.concat([
    ...
    reanimations_confinement_1_nom["Seine-Maritime"]],
    axis=1)
...
reanimations_confinement_1_Pays_de_la_Loire = pd.concat([
    ...
    reanimations_confinement_1_nom["Maine-et-Loire"]],
    axis=1)
...
reanimations_confinement_1_Centre_Val_de_Loire = pd.concat([
    ...
    reanimations_confinement_1_nom["Loiret"]],
    axis=1)
...
reanimations_confinement_1_Bourgogne_Franche_Comte = pd.concat([
    ...
    reanimations_confinement_1_nom["Yonne"]],
    axis=1)
...
reanimations_confinement_1_Grand_Est = pd.concat([
    ...
    reanimations_confinement_1_nom["Vosges"]],
    axis=1)
...
reanimations_confinement_1_Hauts_de_France = pd.concat([
    ...
    reanimations_confinement_1_nom["Somme"]],
    axis=1)
...
reanimations_confinement_1_Ile_de_France = pd.concat([
    ...
    reanimations_confinement_1_nom["Val-d'Oise"]],
    axis=1)
...
reanimations_confinement_1_Nouvelle_Aquitaine = pd.concat([
    ...
    reanimations_confinement_1_nom["Haute-Vienne"]],
    axis=1)
...
reanimations_confinement_1_Auvergne_Rhone_Alpes = pd.concat([
    ...
    reanimations_confinement_1_nom["Haute-Savoie"]],
    axis=1)
...
reanimations_confinement_1_Occitanie = pd.concat([
    ...
    reanimations_confinement_1_nom["Tarn-et-Garonne"]],
    axis=1)
...
reanimations_confinement_1_Outre_Mer = pd.concat([
    ...
    reanimations_confinement_1_nom["Mayotte"]],
    axis=1)

reanimation_confinement_1_regions = {}

reanimation_confinement_1_regions['Bretagne'] =
reanimations_confinement_1_Bretagne

reanimation_confinement_1_regions['Normandie'] =
reanimations_confinement_1_Normandie

reanimation_confinement_1_regions['Pays de la Loire'] =
reanimations_confinement_1_Pays_de_la_Loire

reanimation_confinement_1_regions['Centre-Val-de-Loire'] =
reanimations_confinement_1_Centre_Val_de_Loire

reanimation_confinement_1_regions['Bourgogne-Franche-Comté'] =
reanimations_confinement_1_Bourgogne_Franche_Comte

reanimation_confinement_1_regions['Grand-Est'] =
reanimations_confinement_1_Grand_Est

reanimation_confinement_1_regions['Hauts-de-France'] =
reanimations_confinement_1_Hauts_de_France

reanimation_confinement_1_regions['Île-de-France'] =
reanimations_confinement_1_Ile_de_France

reanimation_confinement_1_regions['Nouvelle-Aquitaine'] =
reanimations_confinement_1_Nouvelle_Aquitaine

reanimation_confinement_1_regions['Auvergne-Rhône-Alpes'] =
reanimations_confinement_1_Auvergne_Rhone_Alpes

reanimation_confinement_1_regions['Occitanie'] =
reanimations_confinement_1_Occitanie

reanimation_confinement_1_regions["Provences-Alpes-Côte-d'Azur"] =
reanimations_confinement_1_Provences_Alpes_Côte_Azur

reanimation_confinement_1_regions['Corse'] = reanimations_confinement_1_Corse

reanimation_confinement_1_regions["Régions d'Outre Mer"] =
reanimations_confinement_1_Outre_Mer


def confinement_1_regions(region):
    fig = px.line(
        reanimation_confinement_1_regions[f'{region}'],
        x="date", y=reanimation_confinement_1_regions[f'{region}'].columns,
        title=f'ICU beds occupied during the 1st confinement in {region}',
        height=500, width=800)
    fig.update_xaxes(
        dtick='M1',
        tickformat="%d\n%b")
